        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountEnum = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppoitmentEnum = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppoitmentTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppoitmentTimes_Appoitments_AppoitmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppoitmentTimes_AppoitmentId",
                table: "AppoitmentTimes",
                column: "AppoitmentId");
